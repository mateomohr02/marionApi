...
const {getCourses, getUserCourses, addCourse, addUserToCourse, addPostToCourseForum, getCourseForumPosts, getForumPostDetail, getCourseByName} = require('../controller/coursesController.js');
...
router.route('/get-course-by-name').get(authentication, getCourseByName);
